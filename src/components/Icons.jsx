...
export function ServerIcon({ size }) {
  return (
    <Svg size={size}>
...
export function DatabaseIcon({ size }) {
  return (
    <Svg size={size}>
...
export function FileTextIcon({ size }) {
  return (
    <Svg size={size}>
...
export function BookOpenIcon({ size }) {
  return (
    <Svg size={size}>
...
export function LayersIcon({ size }) {
  return (
    <Svg size={size}>
